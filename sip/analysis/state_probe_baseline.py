...
if __name__ == "__main__":
    ...
    #Re-initialize model to byt5-small
    model.model = transformers.AutoModelForSeq2SeqLM.from_pretrained("google/byt5-small")
    ...
    #Output:
    #State probe accuracy 42.88166696264725 %
    #Sequence acc 8.149646107178969 %
    
    probe.save_pretrained("models/probe_states_on_byt5.pt")
